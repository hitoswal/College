...
void UART_Init(void)
{
	...
	UART1_IBRD_R = 325;
	// IBRD=int(50000000/(16*9600)) = int(325.52083333)
	UART1_FBRD_R = 33;
	// FBRD = round(0.52083333 * 64) = 33.33
	...
	GPIO_PORTC_DEN_R |= 0x30; // digital I/O on PC4-PC5
	GPIO_PORTC_AMSEL_R &= ~0x30; // No analog on PC4-PC5
}
