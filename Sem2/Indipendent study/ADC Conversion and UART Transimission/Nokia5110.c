...
//********Nokia5110_OutUDec_Int*****************
// Output a 4-bit number in unsigned decimal format with a
// fixed size of 1 right-justified digits of output.
// Inputs: n  4-bit unsigned number
// Outputs: none
// assumes: LCD is in default horizontal addressing mode (V = 0)
void Nokia5110_OutUDec_Int(unsigned short n)
{
  if(n < 10)
	{
...
//********Nokia5110_OutUDec_Frac*****************
// Output a 12-bit number in unsigned decimal format with a
// fixed size of 3 right-justified digits of output.
// Inputs: n  12-bit unsigned number
// Outputs: none
// assumes: LCD is in default horizontal addressing mode (V = 0)
void Nokia5110_OutUDec_Frac(unsigned short n){
  if(n < 10)
		{
			Nokia5110_OutString("  ");
			Nokia5110_OutChar(n+'0'); /* n is between 0 and 9 */
...
//********Nokia5110_OutHex*****************
// Output a 16-bit number in Hexadecimal format.
// Inputs: n  16-bit unsigned number
// Outputs: none
// assumes: LCD is in default horizontal addressing mode (V = 0)

void Nokia5110_OutHex(unsigned short n){
  if(n >= 0x10){
    Nokia5110_OutHex(n/0x10);
    Nokia5110_OutHex(n%0x10);
  }
  else{
    if(n < 0xA){
